...
object DeviceMetadata {
  import ClientInfo.UriReads

  implicit val DeviceMetadataReads: Reads[DeviceMetadata] = (
    (__ \ "uuid").read[UUID].map(Uuid.fromJava) and
    (__ \ "credentials").read[ClientInfo]
  )(DeviceMetadata.apply _)
}
