...
/**
  * Keeps track of the association between (user-provided) [[Device.Id]] and ClientID (the latter generated by Auth+).
  */
final case class VehicleMetadata(deviceId: Device.Id,
