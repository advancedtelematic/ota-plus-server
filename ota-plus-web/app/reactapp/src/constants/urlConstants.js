...
export const URL_CUSTOM_DEVICE_FIELDS_REMOVE = 'https://docs.ota.here.com/ota-web/dev/remove-custom-device-field.html';
...
export const URL_ENVIRONMENTS_LEAVE = 'https://docs.ota.here.com/ota-web/dev/leave-environment.html';
