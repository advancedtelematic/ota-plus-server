...
export const URL_DOCS = 'https://docs.ota.here.com/getstarted/dev/index.html';
export const URL_GET_STARTED = 'https://docs.ota.here.com/getstarted/dev/get-started.html';
