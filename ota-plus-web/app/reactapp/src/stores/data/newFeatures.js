    ...
    slides: {
      ...
      createUpdate: {
        feature: {
          ...
          message: {
            __html:
              '<p>You use this workflow to put your update tasks into groups called “Updates”. For example, suppose you want to update some voice control software from version 1 to 2. You also want to update the parking assistance software from version 10 to 11. You can group these two tasks into one Update and call it something like “IVI Updates Sept 2018”.</p>' +
      ...
      metadata: {
        feature: {
          ...
          message:
            'You can now request approval from end users to install the software. By default, OTA Connect installs your software updates “silently”. There is usually no interaction required from the end user. However, you might be required to ask the end user’s permission before you install certain types of updates. For example, if the update makes the vehicle temporarily unusable. In this step, you can now configure an installation prompt and notification for the end user to read.',
          url: '/campaigns',
          popoverImage: {
