...
@observer
class SoftwareRepositoryAlpha extends Component {
  ...
  render() {
    ...
    return (
      <div className='software-repository-alpha'>
        <div className='wrapper-full'>
          <div className='container'>
            <div className='row'>
              ...
              <div className='software' id='software' onScroll={this.scroll}>
                <div className='section-header'>Software</div>
                <ul className='first-level'>{!_.isEmpty(toJS(this.associatedPackages)) ? packagesList : <p className='absolute-align'>No associated software</p>}</ul>
              </div>
...
export default SoftwareRepositoryAlpha;
