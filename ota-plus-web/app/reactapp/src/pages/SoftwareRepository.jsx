            ...
            <div className='row'>
              <div className='keys' id='keys'>
                ...
                <div className='wrapper-software' onScroll={this.scroll}>
                  <TreeUl data={roles} shown={true} openTreeNode={this.openTreeNode} getParentsUntil={this.getParentsUntil} filterPackagesAndCampaigns={this.filterPackagesAndCampaigns} />
                </div>
              </div>
