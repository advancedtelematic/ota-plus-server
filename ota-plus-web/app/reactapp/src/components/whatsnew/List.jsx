                                        ...
                                        _.map(version.slides, (slide, i) => {
                                            ...
                                            return (
                                                <div className="item" key={i}>
                                                    <div className="image-box"><img src={slide.feature.blogImage.src} alt=""/></div>
                                                    <div className="description-box">
                                                        <div className="date"> DATE OF RELEASE: {version.dataOfRelease}</div>
                                                        <div className="title">{slide.feature.title}</div>
                                                        {
                                                            !slide.feature.message.__html ?
                                                                <div className="message">{ slide.feature.message }</div>
                                                            :
                                                                <div className="message" dangerouslySetInnerHTML={ slide.feature.message }/>
                                                        }
                                                    </div>
                                                </div>
                                            )
