        ...
        return (
            <li className={version.isBlackListed ? "blacklist" : ""}>
                ...
                <div className="right-box">
                    <span title={version.id.version} className="version-name" id={"wizard-package-version" + version.id.version}>
                        {version.id.version}
                    </span>
                    {version.isBlackListed ?
                        <button className="btn-blacklist" id="wizard-package-blacklisted"></button>
                    : 
                        <button className={"btn-checkbox" + (isChosen ? " checked" : "")} id={"wizard-select-package-" + version.id.version} onClick={setWizardData.bind(this, version.id.name, version.id.version)}>
