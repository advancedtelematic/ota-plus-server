    ...
    return (
      <div>
        <div className={'item' + (isChosen ? ' selected' : '')} id={'button-group-' + group.groupName}>
          <button className={'btn-checkbox' + (isChosen ? ' checked' : '')} onClick={setWizardData.bind(this, group.id)}>
            <i className='fa fa-check' aria-hidden='true' />
          </button>
          <div className='element-box group' onClick={setWizardData.bind(this, group.id)}>
            ...
            <div className='desc'>
              ...
              <div className='subtitle'>{t('common.deviceWithCount', { count: groupsStore._getGroupDevices(group).length })}</div>
            </div>
          </div>
          {alphaPlusEnabled &&
