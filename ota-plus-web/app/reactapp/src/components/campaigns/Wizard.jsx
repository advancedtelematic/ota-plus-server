          ...
          <div className='internal-body'>
            ...
            <div className='wizard-actions'>
              <div className='wrapper-confirm'>
                {this.isLastStep() ? (
                  <button className='btn-primary btn-red' id='wizard-launch-button' onClick={this.launch} disabled={!currentStep.isFinished}>
                    Launch
                  </button>
                ) : (
                  <button className='btn-primary' id='next-step' onClick={this.nextStep} disabled={!currentStep.isFinished}>
                    Next
                  </button>
                )}
              </div>
