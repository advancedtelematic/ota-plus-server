    ...
    const content = (
      <div className='sequencer-wrapper'>
        ...
        {devicesStore.multiTargetUpdates.length ? (
          <Sequencer wizardIdentifier={devicesStore.multiTargetUpdates[0].updateId} data={null} entity={'device'} readOnly={true} />
        ) : (
          <div className='wrapper-center'>Seems like there is no update.</div>
        )}
      </div>
    );
