...
const staticTextContent = (
  <div className='text-left'>
    <p>In many connected mobility domains, most notably in automotive, it is common to have a device, vehicle, or platform that has
      ...
      and is able to distribute firmware updates to secondary ECUs. </p>
    <p>The term <strong>ECU</strong> comes from automotive, and stands for <strong>Electronic Control Unit.</strong></p>
