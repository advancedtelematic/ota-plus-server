			...
			<li className="overview-panel__item">
				<div className="overview-panel__item-header">
					<div className="overview-panel__item-header--title">
						<span id={"update-id-title-" + item.updateId} className={'overview-panel__item-header--title__label'}>
							Update ID:
						</span>
					...
					<div className="overview-panel__item-header__created">
						<span id={"received-at-title-" + item.updateId} className={'overview-panel__item-header--label'}>
							Received at:
	                    </span>
							...
							<div className="overview-panel__operation" key={ecuSerial}>
								<div className="overview-panel__operation-info">
									<div className="overview-panel__operation-info-line">
                                        ...
                                        <div className="overview-panel__operation-info-block">
											<span id={"ecu-serial-title-" + item.updateId} className="overview-panel__operation-info--label">
												ECU identifier:
											</span>
                                    ...
                                    <div className="overview-panel__operation-info-line">
                                        <div className="overview-panel__operation-info-block">
											<span id={"target-title-" + item.updateId} className="overview-panel__operation-info--label">
												Target:
											</span>
                                        ...
                                        {result.length !== 0 &&
                                        <div className="overview-panel__operation-info-block">
											<span id={"length-title-" + item.updateId} className="overview-panel__operation-info--label">
												Length:
											</span>
