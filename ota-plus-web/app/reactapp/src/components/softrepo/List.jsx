...
export default class List extends PureComponent {
  ...
  showInfo(e, item) {
    this.selectedElement === item ? (this.selectedElement = null) : (this.selectedElement = item);
  }
                  ...
                  >
                    ...
                    <div className='total-progress'>
                      ...
                      <div className='labels row'>
                        ...
                        <div className='col-xs-6'>
                          <p>
                            <span className='label' style={{ backgroundColor: '#898B91', border: '1px solid #ccc' }} />
                            Not impacted: {groupItem.notImpacted}
                          </p>
                          <p>
                            <span className='label' style={{ backgroundColor: '#E7E7E8', border: '1px solid #ccc' }} />
