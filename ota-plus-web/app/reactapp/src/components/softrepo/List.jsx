...
class List extends Component {
  ...
  render() {
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {(groupItem.warnings && groupItem.warnings.length > 0)
                  || (groupItem.errors && groupItem.errors.length > 0) ? (
                  ...
                  <Row className="version row">
                    <Col span={12}>
                      <p>
                        {`Launched: ${groupItem.launched}`}
                      </p>
                      <p>
                        {`Started: ${groupItem.started}`}
                      </p>
                      <p>
                        {`End: ${groupItem.end}`}
                      </p>
                  ...
                  <div className="groups">
                    {_.map(groupItem.groups, (singleGroup, key) => (
                        ...
                        <div className="name">
                          <div className="element-box group">
                            ...
                            <div className="desc">
                              ...
                              <div className="subtitle">{singleGroup.total}</div>
                            </div>
                          </div>
                        </div>
                        <div className="stats">
                          <div className="devices-progress">
                            <div className="progress">
                              <div className="progress-bar" role="progressbar" style={{ width: `${singleGroup.processed}%` }} />
                            </div>
                            <span className="value">{`${singleGroup.processed}%`}</span>
                          </div>
                        </div>
                      </div>
                    ))}
    ...
    return (
      <div>
        {!_.isEmpty(toJS(data.groups)) ? list : <p className="absolute-align">No associated campaigns</p>}
      </div>
    );
  }
}
