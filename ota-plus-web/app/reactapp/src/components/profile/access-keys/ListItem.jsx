  ...
  render() {
    ...
    return (
      <div className='box' id={'key-' + provisioningKey.description}>
        <div className='column'>{provisioningKey.description}</div>
        <div className='column'>Start date: {validFrom.toDateString() + ' ' + validFrom.toLocaleTimeString()}</div>
        <div className='column'>End date: {validUntil.toDateString() + ' ' + validUntil.toLocaleTimeString()}</div>
