      ...
      return (
        <div key={index} className={'filters filters--dark'}>
          <div className='filters__block' style={{ flex: 1 }}>
            <FormInput id='name-filter' name='nameFilter' defaultValue={singleFilterElements[0]} isEditable={false} />
          </div>
          <div className='filters__block' style={{ flex: 1 }}>
            <FormInput id='expression-filter' name='expressionFilter' defaultValue={singleFilterElements[1]} isEditable={false} />
          </div>
          <div className='filters__block' style={{ flex: 5 }}>
            {<FormInput id='word' name='word' className='input-wrapper' defaultValue={singleFilterElements[2]} isEditable={false} />}
          </div>
        </div>
      );
    });
