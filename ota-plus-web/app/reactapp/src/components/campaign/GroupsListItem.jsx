    ...
    return (
      <div className='groups__item'>
        <div className='groups__box groups__box--left'>
          ...
          <div className='groups__item-progress'>
            <div className='groups__item-progress-wrapper'>
              <div
                className={
                  'groups__item-progress-bar progress progress-bar' +
                  (campaign.statistics.status !== 'finished' && campaign.statistics.status !== 'cancelled' && progress !== 100 ? ' progress-bar-striped active' : '')
                }
                role='progressbar'
        ...
        <div className='groups__box groups__box--right'>
          <div>{statistics.processed} processed</div>
          <div>{statistics.affected} affected</div>
        </div>
      </div>
    );
  }
