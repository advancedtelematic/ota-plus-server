...
class ListItemVersion extends Component {
    ...
    render() {
        ...
        if (alphaPlusEnabled && !_.isEmpty(compatibilityData)) {
                ...
                <div className="c-package__sw-box">
                        ...
                        { version.customExists ?
                            <span>
                                <div className="c-package__sw-row">
                                    ...
                                    <span className="c-package__sw-value"
                                          id={ "package-" + packageName + "-version-" + version.id.version.substring(0, 8) }>{ version.id.version }</span>
                                </div>                                 
                                <div className="c-package__sw-row">
                                    <span className="c-package__sw-subtitle">Created at:</span>
                                    <span className="c-package__sw-value"
                                          id={ "package-" + packageName + "-created-at-" + version.id.version.substring(0, 8) }>
                                ...
                                <div className="c-package__sw-row">
                                    ...
                                    <span className="c-package__sw-value"
                                          id={ "package-" + packageName + "-updated-at-" + version.id.version.substring(0, 8) }>
                                ...
                                <div className="c-package__sw-row">
                                    ...
                                    <span className="c-package__sw-value"
                                          id={ "package-" + packageName + "-hash-" + version.id.version.substring(0, 8) }>
                                        { version.packageHash }
                                    </span>
                                </div>
                                <div className="c-package__sw-row">
                                    ...
                                    <span className="c-package__sw-value"
                                          id={ "package-" + packageName + "-target-length-" + version.id.version.substring(0, 8) }>{ version.targetLength }</span>
                                </div>
                            </span>
                            :
                            <span>
                                <div className="c-package__sw-row">
                                    <span className="c-package__sw-subtitle">Hash:</span>
                                    <span className="c-package__sw-value"
                                          id={ "package-" + packageName + "-hash-" + version.id.version.substring(0, 8) }>{ version.packageHash }</span>
                                </div>
                                <div className="c-package__sw-row">
                                    <span className="c-package__sw-subtitle">Length:</span>
                                    <span className="c-package__sw-value"
                    ...
                    <div className="c-package__sw-wrapper">
                         <div className="c-package__hw-row">
                            Installed on <span
                             id={ "package-" + packageName + "-installed-on-ecus-count-" + version.id.version.substring(0, 8) }>{ version.installedOnEcus }</span> ECU(s)
                        </div>
                    </div>
                    <div className="c-package__sw-wrapper">
                        <div className="c-package__hw-row">
                                        ...
                                        (versionCompatibilityData && versionCompatibilityData.required.length) &&
                                            <div className="c-package__relations" id="required">
                                                ...
                                                { _.map(versionCompatibilityData.required, (filepath, i) => {
                                                    ...
                                                    <span className="c-package__relation-name"
                                                          id={ "required-" + pack.id.name }>
                                                        { pack.id.name }
                                                    </span>
                                                            <span className="c-package__relation-version"
                                                                  id={ "required-" + pack.id.version }>
                                                        { pack.id.version }
                                                    </span>
                                                        </div>
                                                    );
                                            ...
                                            <div className="c-package__relations" id="not-compatible">
                                                ...
                                                { _.map(versionCompatibilityData.incompatibles, (filepath, i) => {
                                                    ...
                                                    return (
                                                        <div className="c-package__relation-item" key={ i }>
                                                        <span className="c-package__relation-name"
                                                              id={ "not-compatible-" + pack.id.name }>
                                                            { pack.id.name }
                                                        </span>
                                                            <span className="c-package__relation-version"
                                                                  id={ "not-compatible-" + pack.id.version }>
                                                            { pack.id.version }
                                                        </span>
                                                        </div>
                                                    );
                                            ...
                                            <div className="c-package__relations" id="required-by">
                                                ...
                                                { _.map(versionCompatibilityData.requiredBy, (filepath, i) => {
                                                    ...
                                                    return (
                                                        <div className="c-package__relation-item" key={ i }>
                                                        <span className="c-package__relation-name"
                                                              id={ "required-by-" + pack.id.version }>
                                                            { pack.id.name }
                                                        </span>
                                                            <span className="c-package__relation-version"
                                                                  id={ "required-by-" + pack.id.version }>
