...
. Rename the field.
+
NOTE: The name should not repeat the other field names. It also should not be less than one character or exceed 20 characters and can only contain letters, numbers, spaces, underscores ( _ ), and hyphens (-).
